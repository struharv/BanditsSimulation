...
class SimulatorTest(unittest.TestCase):
    ...
    def test_Simulator(self):
        ...
        self.assertEqual(Simulator.DEFAULT_SIMULATION_TIME, len(nodes[0].cpu_history))
        self.assertEqual(Simulator.DEFAULT_SIMULATION_TIME, len(nodes[0].memory_mb_history))
        self.assertEqual(Simulator.DEFAULT_SIMULATION_TIME, len(nodes[0].storage_mb_history))
        self.assertEqual(Simulator.DEFAULT_SIMULATION_TIME, len(nodes[0].green_energy_history))
