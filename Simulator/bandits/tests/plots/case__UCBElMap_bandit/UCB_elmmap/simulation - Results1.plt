...
set title 'Node ES - Green Energy, CPU utilization'
...
set title 'Node PT - Green Energy, CPU utilization'
...
set title 'Node US - Green Energy, CPU utilization'
...
set title 'Node FR - Green Energy, CPU utilization'
...
set title 'Node HU - Green Energy, CPU utilization'
