...
set output 'UCB Multi Armed Bandit - increasing_30_container_high.pdf'
set key left top
set multiplot layout 5, 1 title "UCB Multi Armed Bandit - increasing\\\_30\\\_container\\\_high" font ",20"
set yrange [0:1]
set xrange [0:86400]
set format x " " 
