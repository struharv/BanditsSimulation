...
set output 'UCB Multi Armed Bandit - bigspikey_large_utilization.pdf'
set key left top
set multiplot layout 7, 1 title "UCB Multi Armed Bandit - bigspikey\\\_large\\\_utilization" font ",20"
set yrange [0:1]
set xrange [0:86400]
set format x " " 
