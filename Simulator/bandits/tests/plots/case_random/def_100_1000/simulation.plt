...
set output 'Random - def_100_1000.pdf'
set key left top
set multiplot layout 6, 1 title "Random - def\\\_100\\\_1000" font ",20"
set yrange [0:1]
set xrange [0:86400]
set format x " " 
set offsets graph 0, 0, 0.05, 0.05
set title 'Green Energy, Performance node0'
plot 'node0.pts' with linespoints linestyle 1 linecolor rgb "green" notitle, 'node0_resources.pts' using 1:($5 == 0 ? NaN:$5)   with points pointtype 0 linecolor rgb "black" notitle
