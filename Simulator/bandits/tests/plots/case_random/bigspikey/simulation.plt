...
set key left top
set multiplot layout 7, 1 title "Random Reschedule - bigspikey" font ",20"
set yrange [0:1]
set xrange [0:86400]
set format x " " 
...
set title 'Green Energy, Performance node4'
plot 'node4.pts' with linespoints linestyle 1 linecolor rgb "green" notitle, 'node4_resources.pts' using 1:5  with points pointtype 0 linecolor rgb "black" notitle
set title 'Green Energy, Performance node5'
plot 'node5.pts' with linespoints linestyle 1 linecolor rgb "green" notitle, 'node5_resources.pts' using 1:5  with points pointtype 0 linecolor rgb "black" notitle
set ylabel ' '
set yrange[0:*]
set title 'Reward'
